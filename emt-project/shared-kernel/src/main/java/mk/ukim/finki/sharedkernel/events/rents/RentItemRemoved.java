...
// pri brisenjeto na postoecki RentItem so cel da se promeni kolicinata na dostapni primeroci od dadenata igra
@Getter
public class RentItemRemoved extends DomainEvent {

    private String productId;
    private int quantity;

    public RentItemRemoved() {
        super(TopicHolder.TOPIC_RENT_ITEM_REMOVED);
    }

    public RentItemRemoved(String productId, int quantity) {
        super(TopicHolder.TOPIC_RENT_ITEM_REMOVED);
